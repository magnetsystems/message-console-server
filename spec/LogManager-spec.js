...
describe('LogManager', function(){
    ...
    it("refreshLogHandlers should initialize all log handlers", function(done) {
        LogManager.refreshLogHandlers();
        done();
    });

    it("setConsoleLogHandler should set console log handler", function(done) {
    ...
    it("setFileLogHandler should set file log handler", function(done) {
    ...
    it("setDatabaseLogHandler should set file log handler", function(done) {
    ...
    it("setEmailAlertsHandler should set file log handler", function(done) {
