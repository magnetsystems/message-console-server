...
describe('UserManager', function(){
    ...
    describe("getBasicAuth", function() {
    ...
    describe("registerGuest", function() {
        ...
        it("should fail registration if the email is missing", function(done) {
            //            delete user.email;
            user.email = '';
        ...
        it("should fail registration if the email is invalid", function(done) {
    ...
    describe("becomeDeveloper", function() {
        var user;
        var password = 'test';
        var firstName = 'John';
        ...
        it("should fail if the magnetId does not exist", function(done) {
    ...
    describe('checkAuthority', function(){
    ...
    describe('validateAndSendCompleteRegistrationEmail', function(){
        var _user;
    ...
    describe('adminResetPassword', function(){
        var _user = {
            userType     : 'developer',
            firstName    : 'Blue',
            lastName     : 'Moon',
