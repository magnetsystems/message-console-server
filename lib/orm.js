...
var singleton = function singleton(){
    ...
    this.setup = function(path, callback, failback){
        var me = this;
        modelsPath = path;
        sequelize.authenticate().complete(function(e){
            if(e){
                if(ENV_CONFIG.App.configured){
                    ...
                    winston.info('Open web browser and navigate to '+ENV_CONFIG.Email.appUrl+'/wizard to perform initial setup.');
                    failback('connect-error');
                }
                return;
            }
