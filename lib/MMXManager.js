...
MMXManager.prototype.createAppUser = function(uid, mmxId, body, cb){
    ...
    body.appId = mmxId;
    body.isAdmin = false;
    me.request('/mmxadmin/rest/v1/user', 'POST', body, function(e, data){
        if(e) return cb(e);
...
MMXManager.prototype.storeAPNSCertificate = function(uid, mmxId, req, cb){
    ...
    req.on('end', function(){
        ...
        me.request('/mmxadmin/rest/v1/apps/'+mmxId+'/apnscert', 'POST', bin, function(e, data, code){
