...
MMXManager.prototype.activateAppUser = function(userMagnetId, mmxId, userId, cb){
    var me = this;
...
// delete an mmx app user
MMXManager.prototype.deactivateAppUser = function(userMagnetId, mmxId, userId, cb){
    var me = this;
...
MMXManager.prototype.deleteAPNSCertificate = function(userMagnetId, mmxId, cb){
    var me = this;
    me.request('/mmxadmin/rest/v1/apps/'+mmxId+'/apnscert', 'DELETE', '', function(e, data){
        if(e) return cb(e);
        cb(null, data);
    }, {
        contentType : 'application/json'
