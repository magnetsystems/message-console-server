...
MMXManager.prototype.getSample = function(userMagnetId, mmxId, platform, cb){
    ...
    me.request('/plugins/mmxmgmt', 'GET', {
        ...
        zip.addLocalFolder(GIT_DIR+'/'+platform);
        zip.addFile(GIT_DIR+'/'+platform+'/app/src/main/res/raw/quickstart.properties', new Buffer(tmpl), 'sample data');
