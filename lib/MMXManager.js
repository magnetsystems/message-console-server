...
MMXManager.prototype.request = function(path, method, data, cb, params){
    ...
    call.on('error', function(e, res, body){
        winston.error('MMXManager: failed to make remote call to '+params.config.host+path+': ', e, res||'', body||'');
...
MMXManager.prototype.createAppUser = function(userMagnetId, mmxId, body, cb){
    var me = this;
    if(!body) return cb('invalid-body');
    body.appId = mmxId;
    body.isAdmin = false;
    me.request('/mmxadmin/rest/v1/user', 'POST', body, function(e, data, code){
        ...
        contentType : 'application/json',
        headers     : {
            'X-mmx-app-owner' : userMagnetId
        }
    });
};

// update an mmx app user
MMXManager.prototype.updateAppUser = function(userMagnetId, mmxId, userId, body, cb){
    var me = this;
    if(!body) return cb('invalid-body');
    body.appId = mmxId;
    me.request('/mmxadmin/rest/v1/user', 'PUT', body, function(e, data, code){
        if(e) return cb(e);
...
MMXManager.prototype.deleteAppUser = function(userMagnetId, mmxId, userId, cb){
    var me = this;
    me.request('/mmxadmin/rest/v1/user/'+userId+'/app/'+mmxId, 'DELETE', '', function(e, data, code){
        if(e) return cb(e);
...
MMXManager.prototype.sendMessage = function(userMagnetId, mmxId, mmxDeviceId, body, cb){
...
MMXManager.prototype.sendPing = function(userMagnetId, mmxId, mmxDeviceId, body, cb){
    var me = this;
...
MMXManager.prototype.sendNotification = function(userMagnetId, mmxId, mmxDeviceId, body, cb){
    var me = this;
...
MMXManager.prototype.createAppTopic = function(userMagnetId, mmxId, body, cb){
    var me = this;
    if(!body) return cb('invalid-body');
...
MMXManager.prototype.getAppTopics = function(userMagnetId, mmxId, query, cb){
    var me = this;
    query.appId = mmxId;
...
MMXManager.prototype.deleteAppTopic = function(userMagnetId, mmxId, topicId, cb){
    var me = this;
    me.request('/mmxadmin/topic?topicid='+encodeURIComponent(topicId), 'DELETE', '', function(e, data, code){
        if(e) return cb(e);
...
// add tags to topic
MMXManager.prototype.addTopicTags = function(userMagnetId, mmxId, topicId, body, req, cb){
    var me = this;
    if(!req.headers['appapikey']) return cb('missing-apikey');
    me.request('/mmxmgmt/api/v1/topics/tags', 'POST', body, function(e, data, code){
        if(e) return cb(e);
        cb(null, 'ok', code);
    }, {
        contentType : 'application/json',
...
MMXManager.prototype.removeTopicTags = function(userMagnetId, mmxId, topicId, body, req, cb){
    var me = this;
    if(!req.headers['appapikey']) return cb('missing-apikey');
    me.request('/mmxmgmt/api/v1/topics/tags?topicId='+topicId+'&tagnames='+body.tags, 'DELETE', '', function(e, data, code){
        if(e) return cb(e);
        cb(null, 'ok', code);
    }, {
        contentType : 'application/json',
...
MMXManager.prototype.publishToTopic = function(userMagnetId, mmxId, topicId, body, cb){
    var me = this;
...
MMXManager.prototype.getConfigs = function(userMagnetId, cb, config){
    var me = this;
