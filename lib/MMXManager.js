...
MMXManager.prototype.request = function(path, method, data, cb, params){
    ...
    var req = {
        ...
        port    : params.port || params.config.port || (params.config.ssl === true ? 443 : 80),
        path    : queryPath,
        method  : method || 'GET',
    ...
    winston.silly('MMXManager: remote call - ', req, reqBody);
...
MMXManager.prototype.updateApp = function(userMagnetId, isAdmin, mmxId, body, cb){
    var me = this;
    if(!body) return cb('invalid-body');
    me.request('/plugins/mmxmgmt/rest/v1/apps/'+mmxId, 'PUT', body, function(e, data){
        if(e) return cb(e);
...
MMXManager.prototype.createAppUser = function(uid, mmxId, body, cb){
    ...
    body.appId = mmxId;
    body.isAdmin = false;
    me.request('/plugins/mmxmgmt/rest/v1/user', 'POST', body, function(e, data){
        if(e) return cb(e);
...
MMXManager.prototype.updateAppUser = function(uid, mmxId, userId, body, cb){
    ...
    if(!body) return cb('invalid-body');
    body.appId = mmxId;
    me.request('/plugins/mmxmgmt/rest/v1/user', 'PUT', body, function(e, data){
        if(e) return cb(e);
...
MMXManager.prototype.deleteAppUser = function(uid, mmxId, userId, cb){
    var me = this;
    me.request('/plugins/mmxmgmt/rest/v1/user/'+userId+'/app/'+mmxId, 'DELETE', '', function(e, data){
        if(e) return cb(e);
...
MMXManager.prototype.setConfigs = function(obj, cb){
    var me = this;
    me.request('/plugins/mmxmgmt/config', 'POST', obj, function(e, data){
        if(e) return cb(e);
        cb(null, data);
    }, {
        contentType : 'application/json'
