...
MMXManager.prototype.getAppStats = function(uid, mmxId, cb){
    var me = this;
    me.request('/plugins/mmxmgmt/stats/app/'+mmxId, 'GET', '', function(e, data){
        if(e) return cb(e);
        cb(null, stats);
    });
};
...
var stats = {
    ...
    "pushMessageStats": {
        "numPingMessages": 300,
        "numPingPongMessages": 100,
        "numConsolePingMessages": 100
    },
    "deviceStats": {
        "numDevices": 86
    }
...
var multipleStats = [
    {
        ...
        "pushMessageStats": {
            "numPingMessages": 82,
            "numPingPongMessages": 16,
            "numConsolePingMessages": 12
        },
        "deviceStats": {
            "numDevices": 86
        }
    },
    {
        ...
        "pushMessageStats": {
            "numPingMessages": 412,
            "numPingPongMessages": 12,
            "numConsolePingMessages": 3
        },
        "deviceStats": {
            "numDevices": 291
        }
    },
    {
        ...
        "pushMessageStats": {
            "numPingMessages": 48,
            "numPingPongMessages": 23,
            "numConsolePingMessages": 135
        },
        "deviceStats": {
            "numDevices": 12
        }
