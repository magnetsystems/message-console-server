...
UserManager.prototype.create = function(userObj, callback){
    ...
    orm.model('User').find({
        ...
        if(!user){
            ...
            var userMagnetId = magnetId.v1();
            // TODO: pritesh can you look at this? every user is created with this uuid
            ...
            console.error('Registration: user "' + userObj.email + '" failed: user already exists');
