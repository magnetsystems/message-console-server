    ...
    EmailService.sendEmail({
        ...
        html    : EmailService.renderTemplate({
            ...
            vars : {
                ...
                resourceUrl : ENV_CONFIG.Email.resourceUrl,
                url         : source ? (source+'/#/complete-register?' + extra + '&t=' + user.magnetId) : (ENV_CONFIG.Email.appUrl + '/login/?a=confirm-registration&' + extra + '&t=' + user.magnetId)
            }
        }),
        success : function(){
                    ...
                    EmailService.sendEmail({
                        ...
                        html    : EmailService.renderTemplate({
                            ...
                            vars : {
                                ...
                                resourceUrl  : ENV_CONFIG.Email.resourceUrl,
                                url          : userObj.source ? (userObj.source+'/#/reset-password?t='+passwordResetToken) : (ENV_CONFIG.Email.appUrl + '/login/?a=reset-password&t=' + passwordResetToken)
                            }
                        }),
                        success : function(){
