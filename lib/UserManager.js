...
UserManager.prototype.read = function(req, callback){
    var attributes = ['email'], where = {
        magnetId : req.params.magnetId
    };
    console.log('test', req.params.magnetId);
    if(req.session.user){
        var attributes = ['email', 'firstName', 'lastName', 'companyName', 'country', 'roleWithinCompany'];
        where = {
                    ...
                    EmailService.sendEmail({
                        ...
                        html    : EmailService.renderTemplate({
                            ...
                            vars : {
                                ...
                                resourceUrl: EmailService.EmailSettings.resourceUrl,
                                url: EmailService.EmailSettings.appUrl + '/login/?a=confirm-registration&s=u&t=' + user.magnetId
                            }
                        }),
                        success : function(){
