    ...
    EmailService.sendEmail({
        ...
        html    : EmailService.renderTemplate({
            ...
            vars : {
                ...
                resourceUrl : ENV_CONFIG.Email.resourceUrl,
                url         : source ? (source+'/messaging/console/#/complete-register?' + extra + '&t=' + user.magnetId) : (ENV_CONFIG.Email.appUrl + '/account/complete-registration?' + extra + '&t=' + user.magnetId)
            }
        }),
        success : function(){
