    ...
    EmailService.sendEmail({
        ...
        html    : EmailService.renderTemplate({
            ...
            vars : {
                ...
                resourceUrl : ENV_CONFIG.Email.resourceUrl,
                url         : source ? (source+'/#/complete-register?' + extra + '&t=' + user.magnetId) : (ENV_CONFIG.Email.appUrl + '/account/complete-registration?' + extra + '&t=' + user.magnetId)
            }
        }),
        success : function(){
                    ...
                    EmailService.sendEmail({
                        ...
                        html    : EmailService.renderTemplate({
                            ...
                            vars : {
                                ...
                                resourceUrl  : ENV_CONFIG.Email.resourceUrl,
                                url          : userObj.source ? (userObj.source+'/#/reset-password?t='+passwordResetToken) : (ENV_CONFIG.Email.appUrl + '/account/reset-password?t=' + passwordResetToken)
                            }
                        }),
                        success : function(){
