...
ConfigManager.prototype.setMessaging = function(obj, cb){
    var me = this;
    if(!obj.host || !obj.user || !obj.password || !obj.port || typeof obj.ssl === 'undefined' || typeof obj.shareDB === 'undefined'){
    ...
    MMXManager.getServerStatus(obj, function(e, status, code){
        ...
        if(typeof status.setupComplete !== 'undefined' && status.setupComplete && !obj.skipProvisioning) return cb('already-configured');
        var mmxConfigs = {
            'mysql.host'       : !obj.shareDB ? obj['mysql.host'] : ENV_CONFIG.Database.host,
            'mysql.port'       : !obj.shareDB ? obj['mysql.port'] : ENV_CONFIG.Database.port,
            'mysql.db'         : !obj.shareDB ? obj['mysql.db'] : ENV_CONFIG.Database.dbName,
            'mysql.user'       : !obj.shareDB ? obj['mysql.user'] : ENV_CONFIG.Database.username,
            'mysql.password'   : !obj.shareDB ? obj['mysql.password'] || ENV_CONFIG.Database.password : ENV_CONFIG.Database.password,
