...
ConfigManager.prototype.init = function(cb){
    ...
    if(me.configs.Redis.enabled){
        me.redis = connectRedis(me.configs.Redis, function(e){
            if(e) return cb(e);
            me.setConfigsIfNotExist(me.redis, function(e){
                if(e) return cb(e);
...
ConfigManager.prototype.setRedis = function(obj, cb){
    ...
    var client = connectRedis(obj, function(e){
        ...
        me.set('Redis', obj, function(e){
            ...
            me.setConfigsIfNotExist(client, cb);
        });
    });
};

ConfigManager.prototype.setConfigsIfNotExist = function(client, cb){
    var me = this;
    client.get(REDIS_ID, function(e, res){
        if(e)
            return cb(e);
        if(!res)
            return client.set(REDIS_ID, JSON.stringify(me.configs), cb);
        me.configs = JSON.parse(res);
        cb();
    });
}
