...
module.exports = {
    model : {
        ...
        jdbcSystemUsername : Seq.STRING,
        jdbcSystemPassword : Seq.STRING,
        jdbcAppEnabled : Seq.BOOLEAN,
        jdbcAppDBName : Seq.STRING,
        jdbcAppUsername : Seq.STRING,
        jdbcAppPassword : Seq.STRING,
        ...
        helloWorldControllerDBEnabled : Seq.BOOLEAN,
